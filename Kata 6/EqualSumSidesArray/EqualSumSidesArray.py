...
of the integers to the left of N is equal to the sum of the integers to the right of N. If there is no index that would make this happen, return -1.
...
# Solución de la comunidad 1. Mismo planteamiento que el mío pero simplificando un poco.
def find_even_index_community(arr):
...
"""
Solución de la comunidad 2. Mi solución es más legible pero menos eficiente en uso de CPU, ya que 
usamos complejidad de O^2 cuando puede ser resuelto en O^1. Entiendo O^n como el número de bucles utilizados.
"""
def find_even_index_community2(arr):

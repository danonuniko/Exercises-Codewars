 ...
 */
 ...
 public class TenMinutesWalk {
	...
	public static boolean isValid(char[] walk) {
		...
		for(char move : walk)
		{
			if(Character.toString(move).equals("n"))            verticalMoves++;
			else if(Character.toString(move).equals("s"))       verticalMoves--;
			else if(Character.toString(move).equals("w"))       horizontalMoves--;
			else if(Character.toString(move).equals("e"))       horizontalMoves++;
		}

...
public class IntegerDepth {
	...
	public static int computeDepth(int n) {
		...
		while(numbers.size() < 10) {
			multiplicador++;
			int multiplication = n * multiplicador;
			String multiplication_str = Integer.toString(multiplication);
			for(char number : multiplication_str.toCharArray())  numbers.add(number);
		}

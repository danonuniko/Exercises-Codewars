...
public class Kata
{
    public static bool TidyNumber(int n)
    {
        ...
        {
            if(int.Parse(n.ToString().Substring(i, 1)) > int.Parse(n.ToString().Substring(i + 1, 1)))     return false;
        }
        return true;
    }
    public static void Main(string[] args)
    {
        System.Console.WriteLine(TidyNumber(12));
        System.Console.WriteLine(TidyNumber(32));
        System.Console.WriteLine(TidyNumber(1024));
        System.Console.WriteLine(TidyNumber(13579));
        System.Console.WriteLine(TidyNumber(2335));
    }
}
...
{
    // Solución de la comunidad de Java.
    public static int Score(int[] dice) 
    {
        int[] repeticiones = new int[7];
        foreach(int number in dice)   repeticiones[number]++;
        return repeticiones[1]/3*1000 + repeticiones[1]%3*100 + repeticiones[2]/3*200 + repeticiones[3]/3*300 + repeticiones[4]/3*400 + repeticiones[5]/3*500 + repeticiones[5]%3*50 + repeticiones[6]/3*600;
    }
}